...
## [~] Cover cmd/helix dry-run wrappers + doctor — 6 zero-coverage funcs
- **Priority:** medium
...
- **AC:**
  1. `go test ./cmd/helix/... -count=1 -cover` ≥ 95.0% (currently 83.8%)
  2. Each of these 6 functions moves from 0% to ≥80% line coverage: `runDispatchDryRun`, `runDispatchWithDryRun`, `errExit.Error`, `runCoapprovalWithDryRun`, `runAdversarialWithDryRun`, `runDoctorWithConfig`
  3. `go build ./...` clean, full suite 40+ packages still green
